...
?>
        ...
        <div class="container-fluid">
          <div class="container animate-box">
            <div class="row">
              <div
                class="owl-carousel owl-theme js carausel_slider section_margin"
                id="slider-small"
              >
                <div class="item px-2">
                  <div class="alith_latest_trading_img_position_relative">
                    <figure class="alith_post_thumb">
                      <a href="#"
                        ><img src="assets/images/thumb_small_1.png" alt=""
                      /></a>
                    </figure>
                    <div class="alith_post_title_small">
                      <a href="single.php"
                        ><strong><?php echo $lorem2; ?></strong></a
                      >
                      <p class="meta">
                        <span><?php echo $fblog; ?></span><span>600 vistas</span>
                      </p>
                    </div>
                  </div>
                </div>
                <div class="item px-2">
                  <div class="alith_latest_trading_img_position_relative">
                    <figure class="alith_post_thumb">
                      <a href="single.php"
                        ><img src="assets/images/thumb_small_2.png" alt=""
                      /></a>
                    </figure>
                    <div class="alith_post_title_small">
                      <a href="single.php"
                      ...
                      >
                      <p class="meta">
                        <span><?php echo $fblog1; ?></span> <span>100 vistas</span>
                      </p>
                    </div>
                  </div>
                </div>
                <div class="item px-2">
                  <div class="alith_latest_trading_img_position_relative">
                    <figure class="alith_post_thumb">
                      <a href="single.php"
                        ><img src="assets/images/thumb_small_3.png" alt=""
                      /></a>
                    </figure>
                    <div class="alith_post_title_small">
                      <a href="single.php"
                      ...
                      >
                      <p class="meta">
                        <span><?php echo $fblog2; ?></span> <span>200 vistas</span>
                      </p>
                    </div>
                  </div>
                </div>
                <div class="item px-2">
                  <div class="alith_latest_trading_img_position_relative">
                    <figure class="alith_post_thumb">
                      <a href="single.php"
                        ><img src="assets/images/thumb_small_4.png" alt=""
                      /></a>
                    </figure>
                    <div class="alith_post_title_small">
                      <a href="single.php"
                        ><strong><?php echo $lorem2; ?></strong>
                      </a>
                      <p class="meta">
                        <span><?php echo $fblog3; ?></span> <span>300 vistas</span>
                      </p>
                    </div>
                  </div>
                </div>
                <div class="item px-2">
                  <div class="alith_latest_trading_img_position_relative">
                    <figure class="alith_post_thumb">
                      <a href="single.php"
                        ><img src="assets/images/thumb_small_5.png" alt=""
                      /></a>
                    </figure>
                    <div class="alith_post_title_small">
                      <a href="single.php"
                      ...
                      >
                      <p class="meta">
                        <span><?php echo $fblog4; ?></span> <span>400 vistas</span>
                      </p>
                    </div>
                  </div>
                </div>
                <div class="item px-2">
                  <div class="alith_latest_trading_img_position_relative">
                    <figure class="alith_post_thumb">
                      <a href="single.php"
                        ><img src="assets/images/thumb_small_6.png" alt=""
                      /></a>
                    </figure>
                    <div class="alith_post_title_small">
                      <a href="single.php"
                      ...
                      >
                      <p class="meta">
                        <span><?php echo $fblog5; ?></span> <span>500 vistas</span>
                      </p>
                    </div>
                  </div>
                </div>
          ...
          <div class="container">
            <div class="primary margin-15">
              <div class="row">
                <div class="col-md-8">
                  <div
                    class="owl-carousel owl-theme js section_margin line_hoz animate-box"
                    id="slideshow_face"
                  >
                    <div class="item">
                      <figure class="alith_post_thumb_big">
                        ...
                        >
                        <a href="single.php"
                          ><img src="assets/images/slideshow-1.jpg" alt=""
                        /></a>
                      </figure>
                      <h3
                        class="alith_post_title animate-box"
                        ...
                        <div class="row">
                          <div class="col-md-4 col-sm-12">
                            <div class="post_meta_center animate-box">
                              ...
                              <p>
                                <a class="author" href="page-author.html"
                                  ><strong>Nombre del Autor</strong></a
                                >
                              </p>
                          ...
                          <div class="col-md-8 col-sm-12 animate-box">
                            <p class="alith_post_except"><?php echo $lorem2; ?></p>
                          </div>
                        </div>
                      </div>
                    </div>
                    <div class="item">
                      <figure class="alith_post_thumb_big">
                        ...
                        >
                        <a href="#"
                          ><img src="assets/images/slideshow-2.jpg" alt=""
                        /></a>
                      </figure>
                      <h3
                        class="alith_post_title animate-box"
                        ...
                        <div class="row">
                          <div class="col-md-4 col-sm-12">
                            <div class="post_meta_center animate-box">
                              ...
                              <span class="post_meta_date"><?php echo $fblog4; ?></span>
                            </div>
                          </div>
                          <div class="col-md-8 col-sm-12 animate-box">
                    ...
                    <div class="item">
                      <figure class="alith_post_thumb_big">
                        ...
                        >
                        <a href="#"
                          ><img src="assets/images/slideshow-3.jpg" alt=""
                        /></a>
                      </figure>
                      <h3
                        class="alith_post_title animate-box"
                        ...
                        <div class="row">
                          <div class="col-md-4 col-sm-12">
                            <div class="post_meta_center animate-box">
                              ...
                              <span class="post_meta_date"><?php echo $fblog3; ?></span>
                            </div>
                          </div>
                          <div class="col-md-8 col-sm-12 animate-box">
                            <p class="alith_post_except"><?php echo $lorem4; ?></p>
                          </div>
                        </div>
                      </div>
                    </div>
                  ...
                  <div class="post_list post_list_style_1">
                    <div class="alith_heading">
                      <h2 class="alith_heading_patern_2"> Publicaciones Recientes</h2>
                    </div>
                    <article class="row section_margin animate-box">
                      <div class="col-md-3 animate-box">
                        <figure class="alith_news_img">
                          <a href="single.php"
                            ><img src="assets/images/thumb_medium_1.png" alt=""
                          /></a>
                        </figure>
                      </div>
                      <div class="col-md-9 animate-box">
                        ...
                        <div class="post_meta">
                          ...
                          <span class="meta_categories"
                            ><a href="archive.php">Politicas</a>,
                    ...
                    <article class="row section_margin animate-box">
                      <div class="col-md-3 animate-box">
                        <figure class="alith_news_img">
                          <a href="single.php"
                            ><img src="assets/images/thumb_medium_2.png" alt=""
                          /></a>
                        </figure>
                      </div>
                      <div class="col-md-9 animate-box">
                    ...
                    <article class="row section_margin animate-box">
                      <div class="col-md-3 animate-box">
                        <figure class="alith_news_img">
                          <a href="single.php"
                            ><img src="assets/images/thumb_medium_3.png" alt=""
                          /></a>
                        </figure>
                      </div>
                      <div class="col-md-9 animate-box">
                    ...
                    <article class="row section_margin animate-box">
                      <div class="col-md-3 animate-box">
                        <figure class="alith_news_img">
                          <a href="single.php"
                            ><img src="assets/images/thumb_medium_4.png" alt=""
                          /></a>
                        </figure>
                      </div>
                      <div class="col-md-9 animate-box">
                        ...
                        <div class="post_meta">
                          ...
                          <span class="meta_categories"
                            ...
                            <a href="archive.php">Noticias</a></span
                          >
                          <span class="meta_date"><?php echo $fblog5; ?></span>
                        </div>
                      </div>
                    </article>
                    <article class="row section_margin animate-box">
                      <div class="col-md-3 animate-box">
                        <figure class="alith_news_img">
                          <a href="single.php"
                            ><img src="assets/images/thumb_medium_5.png" alt=""
                          /></a>
                        </figure>
                      </div>
                      <div class="col-md-9 animate-box">
                    ...
                    <article class="row section_margin animate-box">
                      <div class="col-md-3 animate-box">
                        <figure class="alith_news_img">
                          <a href="single.php"
                            ><img src="assets/images/thumb_medium_6.png" alt=""
                          /></a>
                        </figure>
                      </div>
                      <div class="col-md-9 animate-box">
