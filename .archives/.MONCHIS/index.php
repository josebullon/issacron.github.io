          ...
          <div class="swiper-wrapper">
              ...
              <div class="featured-post-card img-hover-scale">
                <div class="post-card-inner">
                  <div class="featured-post-thumb media">
                    <a href="category.php" class="featured-post-cat">Viajes</a>
                  ...
                  <div class="featured-post-info">
                    <div class="featured-post-meta">
                      <div class="author-thumb">
                        <a href="author.php"
                          ><img src="assets/img/author-1.jpg" alt="author"
                        /></a>
                      </div>
                      <ul class="post-meta">
                        <li><a href="single.php">Nombre del Autor</a></li>
                        <li class="sep"></li>
                        <li>
                          <a class="date" href="archive.php"><?php echo $fblog; ?></a>
                        </li>
                      </ul>
                    </div>
                    <h2>
            ...
            <div class="swiper-slide slide-size-xl dl-drag-cursor">
              <div class="featured-post-card img-hover-scale">
                <div class="post-card-inner">
                  <div class="featured-post-thumb media">
                    <a href="category.php" class="featured-post-cat"
                      >Deporte</a
                    >
                  ...
                  <div class="featured-post-info">
                    <div class="featured-post-meta">
                      <div class="author-thumb">
                        <a href="single.php"
                          ><img src="assets/img/author-2.jpg" alt="author"
                        /></a>
                      </div>
                      <ul class="post-meta">
                        <li><a href="author.php">Nombre del Autor</a></li>
                        <li class="sep"></li>
                        <li>
                          <a class="date" href="author.php"><?php echo $fblog1; ?></a>
                        </li>
                      </ul>
                    </div>
                    <h2>
            ...
            <div class="swiper-slide slide-size-xs dl-drag-cursor">
              <div class="featured-post-card img-hover-scale">
                <div class="post-card-inner">
                  <div class="featured-post-thumb media">
                    <a href="category.php" class="featured-post-cat">Comida</a>
                  ...
                  <div class="featured-post-info">
                    <div class="featured-post-meta">
                      <div class="author-thumb">
                        <a href="single.php"
                          ><img src="assets/img/author-3.jpg" alt="author"
                        /></a>
                      </div>
                      <ul class="post-meta">
                        <li><a href="author.php">Nombre del Autor</a></li>
                        <li class="sep"></li>
                        <li>
                          <a class="date" href="author.php"><?php echo $fblog2; ?></a>
                        </li>
                      </ul>
                    </div>
                    <h2>
                      <a href="single.pho" class="text-hover"
                        ><?php echo $lorem4; ?></a
                      >
                    </h2>
                    <a href="single.php" class="read-more">Leer más</a>
                ...
                <div class="post-card-inner">
                  ...
                  <div class="featured-post-info">
                    <div class="featured-post-meta">
                      <div class="author-thumb">
                        <a href="single.php"
                          ><img src="assets/img/author-4.jpg" alt="author"
                        /></a>
                      </div>
                      <ul class="post-meta">
                        <li><a href="author.php">Nombre del autor</a></li>
                        <li class="sep"></li>
                        <li>
                          <a class="date" href="author.php"><?php echo $fblog3; ?></a>
                        </li>
                      </ul>
                    </div>
                    <h2>
                      <a href="author.php" class="text-hover"
                        ><?php echo $lorem4; ?></a
                      >
                    </h2>
                    <a href="author.php" class="read-more">Leer más</a>
                  </div>
                </div>
              </div>
            </div>
                ...
                <div class="post-card-inner">
                  ...
                  <div class="featured-post-info">
                    <div class="featured-post-meta">
                      <div class="author-thumb">
                        <a href="single.php"
                          ><img src="assets/img/author-5.jpg" alt="author"
                        /></a>
                      </div>
                      <ul class="post-meta">
                        <li><a href="single.php">Nombre del Autor</a></li>
                        <li class="sep"></li>
                        <li>
                          <a class="date" href="single.php"><?php echo $fblog4; ?></a>
                        </li>
                      </ul>
                    </div>
                    <h2>
        ...
        <div class="row">
          <div class="featured-category">
            <div class="category-card img-hover-move">
              <a href="category.php" class="cat-thumb media">
                <img src="assets/img/post-1.jpg" alt="cat" />
                <div class="cat-text">Viajes</div>
              </a>
            </div>
            <div class="category-card img-hover-move">
              <a href="category.php" class="cat-thumb media">
                <img src="assets/img/post-2.jpg" alt="cat" />
                <div class="cat-text">Deporte</div>
              </a>
            </div>
            <div class="category-card img-hover-move">
              <a href="category.php" class="cat-thumb media">
                <img src="assets/img/post-3.jpg" alt="cat" />
                <div class="cat-text">Comida</div>
              </a>
            </div>
            <div class="category-card img-hover-move">
              <a href="category.php" class="cat-thumb media">
                <img src="assets/img/post-4.jpg" alt="cat" />
                <div class="cat-text">Moda</div>
              </a>
            </div>
            <div class="category-card img-hover-move">
              <a href="category.php" class="cat-thumb media">
                <img src="assets/img/post-5.jpg" alt="cat" />
                <div class="cat-text">Fotos</div>
              </a>
            </div>
            <div class="category-card img-hover-move">
              <a href="category.php" class="cat-thumb media">
                <img src="assets/img/post-6.jpg" alt="cat" />
                <div class="cat-text">Salud</div>
              </a>
            </div>
          </div>
        </div>
            ...
            <div class="post-content">
              <ul class="post-meta">
                <li class="reading-time">
                  ...
                  <span class="post-meta-text">45 Minutos</span>
                </li>
                <li>
                  <svg
                    xmlns="http://www.w3.org/2000/svg"
            ...
            <div class="post-content">
              <ul class="post-meta">
                <li class="reading-time">
                  ...
                  <span class="post-meta-text">1 Hora</span>
                </li>
                <li>
                  <svg
                    xmlns="http://www.w3.org/2000/svg"
            ...
            <div class="post-content">
              <ul class="post-meta">
                <li class="reading-time">
                  ...
                  <span class="post-meta-text">1:25 Minutos</span>
                </li>
                <li>
                  <svg
                    xmlns="http://www.w3.org/2000/svg"
                  ...
                  <a href="category.php" class="post-meta-text">Fotos</a>
                </li>
              </ul>
              <h3>
                <a href="single.php" class="text-hover"
              ...
              <ul class="author-info">
                <li>
                  <a href="#"
                    ><img src="assets/img/author-4.jpg" alt="thumb"
                  /></a>
                </li>
                <li>
                  <a href="#">Nombre del Autor</a>
            ...
            <div class="post-content">
              <ul class="post-meta">
                <li class="reading-time">
                  ...
                  <span class="post-meta-text">2 Horas</span>
                </li>
                <li>
                  <svg
                    xmlns="http://www.w3.org/2000/svg"
                  ...
                  <a href="category.php" class="post-meta-text">Salud</a>
                </li>
              </ul>
              <h3>
                <a href="single.php" class="text-hover"
              ...
              <ul class="author-info">
                <li>
                  <a href="#"
                    ><img src="assets/img/author-5.jpg" alt="thumb"
                  /></a>
                </li>
                <li>
                  <a href="#">Nombre del Autor</a>
              ...
              <div class="post-wrap-heading">
                <h3>
                  ...
                  >
                    ...
                    ></path></svg
                  ><span>Antiguas Publicaciones</span>
                </h3>
              </div>
              <div class="row gy-4">
                  ...
                  <div class="post-card format-video img-hover-move">
                    ...
                    <div class="post-content">
                      ...
                      <ul class="post-card-footer">
                        <li>
                          <a href="single.phphtml" class="read-more"
                            >Seguir Leyendo</a
                          >
                        </li>
                        <li>
                ...
                <article class="col-md-12">
                  <div class="post-card full-width-post img-hover-move">
                    <div class="post-thumb media">
                      <a href="single.php">
                        <img src="assets/img/post-11.jpg" alt="thumb" />
                      </a>
                    </div>
                    <div class="post-content">
                      <ul class="post-meta">
              ...
              <div class="sidebar-widget widget">
                <div class="author-widget">
                  ...
                  <div class="author-content">
                    <h3>
                      <a href="#">Nombre del Autor</a><span>Escritor</span>
                    </h3>
                    <p>
                    <?php echo $lorem1; ?>
                    </p>
