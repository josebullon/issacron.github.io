              ...
              <ul class="comments-box">
                    ...
                    <li class="comment">
                      <div class="comment-inner">
                        ...
                        <div class="comment-wrap">
                          <div class="comments-meta">
                            <h4>
                              Nombre del Autor <span><?php echo $lorem5; ?></span>
                            </h4>
                          </div>
                          <div class="comment-area">
                            <p>
                ...
                <li class="comment">
                  <div class="comment-inner">
                    ...
                    <div class="comment-wrap">
                      <div class="comments-meta">
                        <h4>Nombred del Autor<span><?php echo $fblog5; ?></span></h4>
                      </div>
                      <div class="comment-area">
                        <p>
                        <?php echo $lorem1; ?>
                ...
                <div class="widget-post-items">
                  ...
                  <div class="widget-post-item img-hover-move">
                    ...
                    <div class="widget-post-content">
                      ...
                      <ul class="post-meta">
                        <li><a href="category.php">Investigación</a></li>
                        <li class="sep"></li>
                        <li>
                          <a href="category.php" class="date"><?php echo $fblog2; ?></a>
                        </li>
