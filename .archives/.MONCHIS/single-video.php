            ...
            <div class="row">
                <div class="col-lg-8 offset-lg-2">
                    <div class="single-post-thumb">
                        <div style="padding:56.25% 0 0 0;position:relative;"><iframe src="https://player.vimeo.com/video/916386549?badge=0&amp;autopause=0&amp;player_id=0&amp;app_id=58479" frameborder="0" allow="autoplay; fullscreen; picture-in-picture" style="position:absolute;top:0;left:0;width:100%;height:100%;" title="video (1080p)"></iframe></div>
                    </div>
                    <header class="entry-header">
                        ...
                        <h2 class="post-title"><?php echo $lorem4; ?></h2>
                    </header>
                    <div class="single-post-content">
                        ...
                        <blockquote>
                            <svg width="54" height="40" viewBox="0 0 54 40" fill="none" xmlns="http://www.w3.org/2000/svg"><g clip-path="url(#clip0_311_7235)"><path d="M11.3087 24.2569V23.2569H10.3087H1.60408C1.28718 23.2569 1 22.9905 1 22.6238V1.63309C1 1.26637 1.28718 1 1.60408 1H22.2219C22.5388 1 22.826 1.26637 22.826 1.63309V22.6238C22.826 22.6933 22.8149 22.7621 22.7934 22.8275L22.7929 22.8289L17.6385 38.5721C17.5519 38.8371 17.3159 39 17.0675 39H11.9128C11.596 39 11.3087 38.7334 11.3087 38.3669V24.2569Z" stroke="currentColor" stroke-width="2"/><path d="M41.3087 24.2569V23.2569H40.3087H31.6041C31.2872 23.2569 31 22.9905 31 22.6238V1.63309C31 1.26637 31.2872 1 31.6041 1H52.2219C52.5388 1 52.826 1.26637 52.826 1.63309V22.6238C52.826 22.6933 52.8149 22.7621 52.7934 22.8275L52.7929 22.8289L47.6385 38.5721C47.5519 38.8371 47.3159 39 47.0675 39H41.9128C41.596 39 41.3087 38.7334 41.3087 38.3669V24.2569Z" stroke="currentColor" stroke-width="2"/></g><defs><clipPath id="clip0_311_7235"><rect width="54" height="40"/></clipPath></defs></svg>
                            <p><?php echo $lorem1; ?><span>Nombre del Aurtor</span></p>
                        </blockquote>
                            ...
                            <article>
                                <div class="post-card horizontal-card img-hover-move">
                                    ...
                                    <div class="post-content">
                                        ...
                                        <h3><a href="single.php" class="text-hover"><?php echo $lorem4; ?></a></h3>
                                        <ul class="post-card-footer">
                                            <li><a href="single.php" class="read-more">Seguir leyendo</a></li>
                                            <li>
                            ...
                            <article>
                                <div class="post-card horizontal-card img-hover-move">
                                    ...
                                    <div class="post-content">
                                        ...
                                        <h3><a href="single.php" class="text-hover"><?php echo $fblog2; ?></a></h3>
                                        <ul class="post-card-footer">
                                            <li><a href="single.php" class="read-more">Seguir leyendo</a></li>
                                            <li>
                                                <a href="#" class="comment">
                    ...
                    <div class="single-post-item">
                        <ul class="single-post-navigation">
                            <li><a href="single.php"><svg xmlns="http://www.w3.org/2000/svg" height="24" viewBox="0 -960 960 960" width="24" fill="currentColor"><path d="M366.924-213.463 100.001-480.385l266.923-266.922 41.768 41.768-194.54 195.155h646.231v59.999H214.537l195.155 195.154-42.768 41.768Z"/></svg>Prev Posts</a></li>
                            <li><a href="single.php">Publicaciones<svg xmlns="http://www.w3.org/2000/svg" height="24" viewBox="0 -960 960 960" width="24" fill="currentColor"><path d="m593.461-213.463-42.768-41.768 195.155-195.154H100.001v-59.999h646.231L551.693-705.539l41.768-41.768 266.922 266.922-266.922 266.922Z"/></svg></a></li>
                        </ul>
                    </div>
                    <!--/.post-navigation-->
                    ...
                    <div class="single-post-item">
                        <div class="single-post-author">
                            <div class="author-thumb"><a href="author.php"><img src="assets/img/author-widget.jpg" alt="thumb"></a></div>
                            <div class="author-info">
                                <h3><a href="author.php">Nombre del Autor</a> <span>Creador</span></h3>
                                <p><?php echo $lorem1; ?></p>
                                <ul class="post-social-share">
                                <li class="facebook"><a href="#"><svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 512 512" fill="currentColor"><path d="M512 256C512 114.6 397.4 0 256 0S0 114.6 0 256C0 376 82.7 476.8 194.2 504.5V334.2H141.4V256h52.8V222.3c0-87.1 39.4-127.5 125-127.5c16.2 0 44.2 3.2 55.7 6.4V172c-6-.6-16.5-1-29.6-1c-42 0-58.2 15.9-58.2 57.2V256h83.6l-14.4 78.2H287V510.1C413.8 494.8 512 386.9 512 256h0z"></path></svg></a>
                                </li>
                        ...
                        <ul class="comments-box">
                            <li class="comment">
                                <div class="comment-inner">
                                    <div class="comment-thumb"><img src="assets/img/author-1.jpg" alt="img"></div>
                                    <div class="comment-wrap">
                                        <div class="comments-meta">
                                            <h4>Nombre del Autor <span><?php echo $fblog3; ?></span></h4>
                                        </div>
                                ...
                                <ul class="children">
                                    <li class="comment">
                                        <div class="comment-inner">
                                            <div class="comment-thumb"><img src="assets/img/author-2.jpg" alt="img"></div>
                                            <div class="comment-wrap">
                                                <div class="comments-meta">
                            ...
                            <li class="comment">
                                <div class="comment-inner">
                                    <div class="comment-thumb"><img src="assets/img/author-3.jpg" alt="img"></div>
                                    <div class="comment-wrap">
                                        <div class="comments-meta">
                                            <h4>Nombre del Autor <span><?php echo $fblog5; ?></span></h4>
                                        </div>
                        ...
                        <div class="comment-form-wrap">
                            ...
                            <form action="#" method="post" class="comment-form form-horizontal">
                                <div class="comment-form-group">
                                    ...
                                    <div class="form-field">
                                        <input type="text" id="email" name="email" class="form-control" placeholder="Correo" required="">
                                    </div>
                                    <div class="form-field message">
                                        <textarea id="comment" name="comment" cols="30" rows="5" class="form-control comment" placeholder="Escribir comentario" required=""></textarea>
                                    </div>
                                    <div class="form-field submit-btn">
                                        <button id="submit" class="default-btn text-anim" type="submit" data-text="Enviar comentario">Enviar comentario</button>
                                    </div>
                                </div>
                            </form>
                        </div>
