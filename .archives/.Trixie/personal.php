        ...
        <div class="row post-carousel-featured post-carousel">
          ...
          <div class="post featured-post-md">
            <div class="details clearfix">
              <a href="category.php" class="category-badge">Imaginación</a>
              <h4 class="post-title">
            ...
            <a href="blog-single.php">
              <div class="thumb rounded">
                <div
                  ...
                  data-bg-image="images/posts/featured-md-4.jpg"
                ></div>
              </div>
            </a>
          </div>
          ...
          <div class="post featured-post-md">
            <div class="details clearfix">
              <a href="category.php" class="category-badge">Arte</a>
              <h4 class="post-title">
                <a href="blog-single.php"
                  ><?php echo $lorem4; ?></a
                >
            ...
            <a href="blog-single.php">
              <div class="thumb rounded">
                <div
                  class="inner data-bg-image"
                  data-bg-image="images/posts/inspiration-3.jpg"
                ></div>
              </div>
            </a>
          </div>
          ...
          <div class="post featured-post-md">
            <div class="details clearfix">
              <a href="category.php" class="category-badge">Creatividad</a>
              <h4 class="post-title">
                <a href="blog-single.php"
                  ><?php echo $lorem4; ?></a
                >
            ...
            <a href="blog-single.php">
              <div class="thumb rounded">
                <div
                  class="inner data-bg-image"
                  data-bg-image="images/posts/featured-md-1.jpg"
                ></div>
              </div>
            </a>
          </div>
          ...
          <div class="post featured-post-md">
            <div class="details clearfix">
              <a href="category.php" class="category-badge">Inspiración</a>
              <h4 class="post-title">
                <a href="blog-single.php"
                  ><?php echo $lorem4; ?></a
                >
            ...
            <a href="blog-single.php">
              <div class="thumb rounded">
                <div
                  class="inner data-bg-image"
                  data-bg-image="images/posts/featured-md-2.jpg"
                ></div>
              </div>
            </a>
          </div>
          ...
          <div class="post featured-post-md">
            <div class="details clearfix">
              <a href="category.php class="category-badge">Videos</a>
              <h4 class="post-title">
                <a href="blog-single.php"
                  ><?php echo $lorem4; ?></a
                >
            ...
            <a href="blog-single.php">
              <div class="thumb rounded">
                <div
                  class="inner data-bg-image"
                  data-bg-image="images/posts/featured-md-3.jpg"
                ></div>
              </div>
            </a>
          </div>
          ...
          <div class="post featured-post-md">
            <div class="details clearfix">
              <a href="category.php" class="category-badge">Musica</a>
              <h4 class="post-title">
                <a href="blog-single.php"
                  ><?php echo $lorem4; ?></a
                >
