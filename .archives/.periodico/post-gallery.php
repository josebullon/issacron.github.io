                  ...
                  <ul class="breadcrumbs" id="breadcrumbs">
                    ...
                    <li class="item-current item-cat">
                      <strong class="bread-current bread-cat"
                        >Titulo de la Publicacion</strong
                      >
                    </li>
                  </ul>
                </div>
              ...
              <div class="row">
                <div class="col-md-8">
                  <article class="section_margin">
                    <div
                      class="owl-carousel owl-theme js section_margin"
                      id="slideshow_big"
                    >
                      <div class="item">
                    ...
                    <div class="post-content">
                      ...
                      <div class="single-content animate-box">
                        <div class="dropcap column-1 animate-box">
                          ...
                          <p>
                          <?php echo $lorem2; ?>
                            <strong><?php echo $lorem4; ?></strong>
                            <?php echo $lorem2; ?>
                          </p>
                          <p><img alt="" src="assets/images/news-1.jpg" /></p>
                          <p>
                          <?php echo $lorem2; ?>
                          <?php echo $lorem2; ?><em>
                            <?php echo $lorem2; ?></em
                        ...
                        <div class="post-tags">
                          <div class="post-tags-inner">
                            <a href="category-grid.php" rel="tag">#Ciencia</a>
                            ...
                            <div class="col-md-6">
                              <div class="post-navigation">
                                <div class="latest_style_2">
                                  <h5><span>Publicacion Anterior</span></h5>
