            ...
            <div class="row">
              <div class="archive-header">
                <div class="post-author-info">
                  <img
                    class="section_margin_20"
                    src="assets/images/post-author-avatar.jpg"
                    alt="author details"
                  />
                  <div class="archive-title"><h2>Nombre del Autor</h2></div>
                  <p>
                  <?php echo $lorem2; ?>
                  </p>
                  <ul>
        ...
        <div class="container-fluid">
          <div class="container">
            <div class="primary margin-15">
              <div class="row">
                <div class="col-md-8">
                  <h3 class="section_margin"><?php echo $lorem2; ?></h3>
                  <div class="post_list post_list_style_1">
                      ...
                      <div class="col-md-8 animate-box">
                        ...
                        <div class="post_meta">
                          <span class="meta_categories"
                            ><a href="archive.php">Entretenimiento</a>,
                            <a href="archive.php">Politica</a></span
                          >
                        ...
                        <a class="read_more" href="single.php">Leer mas</a>
                      </div>
                    </article>
                    <article class="row section_margin animate-box">
                      <div class="col-md-4 animate-box">
                      ...
                      <div class="col-md-8 animate-box">
                        ...
                        <div class="post_meta">
                          <span class="meta_categories"
                            ...
                            <a href="archive.php">Deporte</a></span
                          >
                    ...
                    <article class="row section_margin animate-box">
                      ...
                      <div class="col-md-8 animate-box">
                        ...
                        <div class="post_meta">
                          <span class="meta_categories"
                            ><a href="archive.php">Internet</a>,
                            <a href="archive.php">Investigacion</a></span
                          >
