              ...
              >
                ...
                <div class="item px-2">
                  <div class="alith_latest_trading_img_position_relative">
                    ...
                    <div class="alith_post_title_small">
                      <a href="single.php"
                        ><strong><?php echo $lorem4; ?></strong></a
                      >
                      <span><?php echo $lorem4; ?></span>
                    </div>
                  </div>
                ...
                <div class="col-md-8">
                  ...
                  <div class="post_list post_list_style_1">
                    <div class="alith_heading">
                      <h2 class="alith_heading_patern_2">Publicaciones</h2>
                    </div>
                      ...
                      <div class="col-md-9 animate-box">
                        ...
                        <div class="post_meta">
                          ...
                          <span class="meta_categories"
                            ><a href="archive.php">Categoria #1</a>,
                            <a href="archive.php">Categoria #2</a></span
                          >
                    ...
                    <article class="row section_margin animate-box">
                      ...
                      <div class="col-md-9 animate-box">
                        ...
                        <div class="post_meta">
                          ...
                          >
                          <span class="meta_categories"
                            ><a href="archive.php">Categoria #3</a>,
                            <a href="archive.php">Categoria #4</a></span
                          >
                          <span class="meta_date"><?php echo $fblog1; ?></span>
                        </div>
                      </div>
                    </article>
                    <article class="row section_margin animate-box">
                      ...
                      <div class="col-md-9 animate-box">
                        ...
                        <div class="post_meta">
                          ...
                          >
                          <span class="meta_categories"
                            ><a href="archive.php">Categoria #5</a>,
                            <a href="archive.php">Categoria #6</a></span
                          >
