      ...
      <div class="ms_download_wrapper common_pages_space">
          <div class="ms_download_inner">
            <div class="album_inner_list">
              <div class="slider_heading_wrap marger_bottom30">
                <div class="slider_cheading">
                  <h4 class="cheading_title">Música Comprada &nbsp;</h4>
                </div>
              </div>
            ...
            <div class="ms_view_more padder_bottom20 padder_top50 text-center">
              <a href="javascript:;" class="ms_btn">Ver más</a>
            </div>
          </div>
        </div>
      </div>
            ...
            <div class="ms_sidemenu_wrapper">
              ...
              <div class="ms_sidemenu_inner">
                ...
                <div class="ms_nav_wrapper">
                  <h4 class="nav_heading">Música</h4>
                  <ul>
                    <li>
                      <a href="index.php" title="Discover">
                        <span class="nav_icon">
                          <span class="icon icon_discover"></span>
                        </span>
                        <span class="nav_text"> Descubrir </span>
                      </a>
                    </li>
                    <li>
                    ...
                    <li>
                      <a href="album.php" title="Albums">
                        ...
                        <span class="nav_text"> Album </span>
                      </a>
                    </li>
                    <li>
                  ...
                  <ul class="nav_downloads">
                    ...
                    <li>
                      <a href="purchase.php" class="active" title="Purchased">
                        <span class="nav_icon">
