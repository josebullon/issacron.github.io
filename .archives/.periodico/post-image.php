        ...
        <div class="container-fluid">
          <div class="container">
            <div class="primary margin-15">
              <div class="row">
                <div class="col-md-12">
                  <figure class="alith_news_img animate-box section_margin">
                    <a href="single.php"
                    ...
                    <div class="post-content">
                      <div class="single-content animate-box">
                        ...
                        <div class="dropcap column-2 animate-box">
                          ...
                          <p>
                          <?php echo $lorem2; ?>
                            <strong><?php echo $lorem2; ?></strong> <?php echo $lorem2; ?>
                          </p>
                          ...
                          <p>
                          <?php echo $lorem2; ?><a href="#"> <?php echo $lorem4; ?></a> <?php echo $lorem2; ?>
                          </p>
                          <p>
                          <?php echo $lorem2; ?>
                          </p>
                        ...
                        <div class="post-tags">
                          <div class="post-tags-inner">
                            ...
                            <a href="category-grid.php" rel="tag"
                              >#Moda</a
                            >
                            <a href="category-grid.php" rel="tag">#Hoga</a>
                          </div>
                        </div>
